            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
                <tr>
                    <td width="90%" align="left" valign="middle">
                        ...
                        <form method="post" action="<?php echo U(selectproduct);?>">
                            <span>id：</span>
                            <input type="text" name="keyword" value="<?php echo ($keywords); ?>" class="text-word" style="width: 70px;">
    ...
    <tr>
        <td align="left" valign="top">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                ...
                <?php if(is_array($xinpin_pros)): $i = 0; $__LIST__ = $xinpin_pros;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
                        ...
                        <td align="center" valign="middle" class="borderright borderbottom"><img src="/webjlcs/Public/<?php echo ($list["path"]); ?>" width="50px"></td>
                        ...
                        <td align="center" valign="middle" class="borderright borderbottom">
                            <?php echo ($list["cat_id"]); ?>
                        </td>
                        <td align="center" valign="middle" class="borderbottom"><a href="<?php echo U('editproduct',array('id'=>$list['id']));?>" target="mainFrame" onFocus="this.blur()" class="add">编辑</a><span class="gray">&nbsp;|&nbsp;</span><a href="<?php echo U('delproduct',array('id'=>$list['id']) );?>" target="mainFrame" onFocus="this.blur()" class="add" onClick="return confirm('删除后不可恢复，请谨慎操作;')">删除</a></td>
