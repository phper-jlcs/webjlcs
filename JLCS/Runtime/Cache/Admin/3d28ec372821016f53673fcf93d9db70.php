        ...
        <td align="left" valign="top">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                <tr>
                    ...
                    <th align="center" valign="middle" class="borderright">文章所属</th>
                ...
                <?php if(is_array($article_lists)): $i = 0; $__LIST__ = $article_lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
                        <td align="center" valign="middle" class="borderright borderbottom"> <?php echo ($list["id"]); ?></td>
                        <td align="center" valign="middle" class="borderright borderbottom"> <?php echo ($list["article_name"]); ?></td>
                        ...
                        <td align="center" valign="middle" class="borderbottom">
                            ...
                            <span class="gray">&nbsp;|&nbsp;</span><a href="<?php echo U('edit',array('id'=>$list['id']));?>" target="mainFrame" onFocus="this.blur()" class="add">编辑</a>
                        </td>
