...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
    <tr>
        <td width="99%" align="left" valign="top">您的位置：转让管理->转让审核</td>
    </tr>
    <tr>
    ...
    <tr>
        <td align="left" valign="top">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                <tr>
                    <th align="center" valign="middle" class="borderright">转让编号</th>
                    <th align="center" valign="middle" class="borderright">转让商品id</th>
                    <th align="center" valign="middle" class="borderright">用户名</th>
                    <th align="center" valign="middle" class="borderright">转让区域名</th>
                    <th align="center" valign="middle" class="borderright">用户真实姓名</th>
                    <th align="center" valign="middle" class="borderright">电话</th>
                    <th align="center" valign="middle" class="borderright">交易地址</th>
                    <th align="center" valign="middle" class="borderright">添加时间</th>
                    <th align="center" valign="middle">操作</th>
                </tr>
                <?php if(is_array($transfers)): $i = 0; $__LIST__ = $transfers;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
                        ...
                        <td align="center" valign="middle" class="borderright borderbottom"> <?php echo ($list["username"]); ?></td>
                        <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($list["name"]); ?></td>
                        <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($list["relname"]); ?></td>
                        <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($list["phone"]); ?></td>
                        <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($list["address"]); ?></td>
                        <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($list["time"]); ?></td>
                        <td align="center" valign="middle" class="borderbottom">
                           <a href="<?php echo U('edits',array('id'=>$list['id']));?>" target="mainFrame" onFocus="this.blur()" class="add">编辑</a>
                            <span class="gray">&nbsp;|&nbsp;</span>
                            <a href="<?php echo U('dels',array('id'=> $list['id']));?>" target="mainFrame" onclick="return del()" class="add" onClick="return confirm('确定删除?删除后不可恢复数据');">删除</a>
