                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
                        ...
                        <td align="left" valign="middle" class="borderright borderbottom main-for">
                            <input type="text" name="product_name" value="<?php echo ($info["product_name"]); ?>" class="text-word" id="name">
                        </td>
                    </tr>
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
                        <td align="right" valign="middle" class="borderright borderbottom bggray">位置：</td>
                        <td align="left" valign="middle" class="borderright borderbottom main-for">
                    ...
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
                        <td align="right" valign="middle" class="borderright borderbottom bggray">尺寸：</td>
                        <td align="left" valign="middle" class="borderright borderbottom main-for">
                    ...
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
                        ...
                        <td align="left" valign="middle" class="borderright borderbottom main-for">
                            <select name="product_store" id="product_store">
                                <?php if(($info["product_store"] == 1)): ?><option value="1" >可售</option>
                                <option value="0">已售</option>
                                    <?php else: ?>
                                    <option value="0">已售</option>
                                    <option value="1">可售</option><?php endif; ?>
                            </select>
                        </td>
                    </tr>
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
