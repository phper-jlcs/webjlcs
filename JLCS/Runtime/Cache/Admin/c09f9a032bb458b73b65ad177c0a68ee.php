        ...
        <td align="left" valign="top">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                <tr>
                    ...
                    <th align="center" valign="middle" class="borderright">位置</th>
                ...
                <?php if(is_array($products)): $i = 0; $__LIST__ = $products;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
                        ...
                        <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($list["size"]); ?></td>
                        <td align="center" valign="middle" class="borderright borderbottom">
                            <?php if(($list["product_store"] == 1)): ?><span style="color:green;font-size: 18px;">可售</span>
                                <?php else: ?>
                                <span style="color:#ccc;font-size: 18px;">已售</span><?php endif; ?>
                        </td>
                        <td align="center" valign="middle" class="borderbottom"><a href="<?php echo U(edit,array('id'=>$list['id']));?>" target="mainFrame" onFocus="this.blur()" class="add">编辑</a><span class="gray">&nbsp;|&nbsp;</span><a href="" target="mainFrame" onFocus="this.blur()" class="add">查看详情</a></td>
