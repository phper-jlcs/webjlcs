...
<div id="left-top">
    ...
    <div style="float: left" id="my_menu" class="sdmenu">
      <div class="collapsed">
        <span>会员管理</span>
        <a href="<?php echo U('User/index');?>" target="mainFrame" onFocus="this.blur()">浏览会员信息</a>
        <a href="<?php echo U('User/add');?>" target="mainFrame" onFocus="this.blur()">添加会员</a>
      ...
      <div>
        <span>莲位/商品管理</span>
        <a href="<?php echo U('Product/index');?>" target="mainFrame" onFocus="this.blur()">浏览莲位</a>
          <a href="<?php echo U('Product/products');?>" target="mainFrame" onFocus="this.blur()">浏览商品</a>
       <a href="<?php echo U('Product/add');?>" target="mainFrame" onFocus="this.blur()">添加商品</a>
      
      </div>
        <div>
            <span>会员卡管理</span>
            <a href="<?php echo U('Usercart/index');?>" target="mainFrame" onFocus="this.blur()">会员卡列表</a>
        </div>
      <div>
        <span>订单管理</span>
        ...
        <div>
            <span>库存管理</span>
            <a href="<?php echo U('Store/store');?>" target="mainFrame" onFocus="this.blur()">单个殿库存</a>
            <a href="<?php echo U('Store/index');?>" target="mainFrame" onFocus="this.blur()">查看总库存</a>
            <!-- <a href="main_list.html" target="mainFrame" onFocus="this.blur()"></a>
            <a href="main_info.html" target="mainFrame" onFocus="this.blur()">角色管理</a>
            <a href="main.html" target="mainFrame" onFocus="this.blur()">自定义权限</a> -->
        </div>
        <div>
            ...
            <a href="<?php echo U('Agent/examine');?>" target="mainFrame" onFocus="this.blur()">代理商审核</a>
            <!-- <a href="main_list.html" target="mainFrame" onFocus="this.blur()"></a>
            <a href="main_info.html" target="mainFrame" onFocus="this.blur()">角色管理</a>
            <a href="main.html" target="mainFrame" onFocus="this.blur()">自定义权限</a> -->
        </div>
        <div>
            <span>转让管理</span>
            <a href="<?php echo U('Examine/index');?>" target="mainFrame" onFocus="this.blur()">转让审核</a>
            <a href="<?php echo U('Examine/liste');?>" target="mainFrame" onFocus="this.blur()">转让列表</a>
        </div>
        <div>
            <span>查询管理</span>
            <a href="<?php echo U('Store/warrant');?>" target="mainFrame" onFocus="this.blur()">供奉权证查询</a>
        </div>
        <div>
            <span>意见管理</span>
            <a href="<?php echo U('Examine/agreement');?>" target="mainFrame" onFocus="this.blur()">客户咨询信息</a>
        </div>
        <div>
            <span>文章管理</span>
