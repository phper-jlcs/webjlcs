...
<frameset rows="95,*,30" cols="*" frameborder="no" border="0" framespacing="0">
    ...
    <frameset id="attachucp" framespacing="0" border="0" frameborder="no" cols="194,12,*" rows="*">
        ...
        <?php if(($sign == '1')): ?><frame scrolling="auto" noresize="" border="0" name="mainFrame" src="<?php echo U('main_list');?>"></frame>
            <?php else: ?>
            <frame scrolling="auto" noresize="" border="0" name="mainFrame" src="main.html"></frame><?php endif; ?>
    </frameset>
    <!--bottom样式-->
