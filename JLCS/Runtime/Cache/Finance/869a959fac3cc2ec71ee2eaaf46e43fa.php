...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
    <tr>
        <td width="99%" align="left" valign="top">您的位置：出账记录</td>
        <div style="position: relative;top:10px;left: 700px;"><a href="javascript:put_out();" class="add fb J_showdialog"><em>选择要导出的出账</em></a></div>
    </tr>
    <tr>
                ...
                <tr>
                    <td width="90%" align="left" valign="middle">
                        <form method="post" action="<?php echo U('selectmonth');?>">
                            <span>按月筛选</span>
                            <select name="month" id="month" style="position: relative;left: 20px;top:10px;" onchange="months()">
        ...
        <td align="left" valign="top" id="shanchu">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                <tr>
                    ...
                    <th align="center" valign="middle" class="borderright">采购总价</th>
                    <th align="center" valign="middle" class="borderright">时间</th>
                    <th align="center" valign="middle" class="borderright">供货商</th>
                    <th align="center" valign="middle">操作</th>
                </tr>
                <?php if(is_array($stock_lists)): $i = 0; $__LIST__ = $stock_lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
                        ...
                        <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($list["price"]); ?></td>
                        <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($list["num"]); ?></td>
                        ...
                        <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($list["hand_man"]); ?></td>
...
//        var all = $(".checkboxa");
        if(all.length != 0) {
            ...
            window.location.href="<?php echo U('Inout/out');?>?id_str="+id_str;
        }else {
            alert('请选中你要导出的订单');
        }
    }
    function months(){
        var monthid = document.getElementById('month').value;
        var url= '/webjlcs/Finance/Finance/selectall';
        $.post(url,{id:monthid},function(data){
//            if(data != ''){
//                $("#main-tab").remove();
//                $(".shanchu").append(data);
//            }else{
