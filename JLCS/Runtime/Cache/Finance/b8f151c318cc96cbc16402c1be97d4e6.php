...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
    <tr>
        <td width="99%" align="left" valign="top">您的位置：盈利状态</td>
        <div style="position: relative;top:10px;left: 700px;"><a href="javascript:put_out();" class="add fb J_showdialog"><em>选择要导出的盈利</em></a></div>
    </tr>
    <tr>
                ...
                <tr>
                    <td width="90%" align="left" valign="middle">
                        <form method="post" action="">
                            <span>按月筛选</span>
                            <select name="" id="month" style="position: relative;left: 20px;top:10px;" onchange="months()">
        ...
        <td align="left" valign="top" id="shanchu">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                <tr>
                    ...
                    <th align="center" valign="middle" class="borderright">总利润</th>
                    <th align="center" valign="middle" class="borderright">成本</th>
                    <th align="center" valign="middle" class="borderright">纯利润</th>
...
//        var all = $(".checkboxa");
        if(all.length != 0) {
            ...
            window.location.href="<?php echo U('Inout/profit');?>?id_str="+id_str;
        }else {
            alert('请选中你要导出的盈利');
        }
    }
