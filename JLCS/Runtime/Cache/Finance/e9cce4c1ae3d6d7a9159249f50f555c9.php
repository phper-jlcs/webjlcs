...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
    <tr>
        <td width="99%" align="left" valign="top">您的位置：库存管理&nbsp;&nbsp;>&nbsp;&nbsp;增加库存</td>
    </tr>
    <tr>
        <td align="left" valign="top">
            <form method="post" action="<?php echo U('doadd_store');?>" onsubmit="return add()">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
                        ...
                        <td align="left" valign="middle" class="borderright borderbottom main-for">
                            <select name="name" id="name">
                                <?php if(is_array($products)): foreach($products as $key=>$list): ?><option value="<?php echo ($list["id"]); ?>"><?php echo ($list["product_name"]); ?></option><?php endforeach; endif; ?>
                            </select>
                        </td>
                    </tr>
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
                    ...
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
                        ...
                        <td align="left" valign="middle" class="borderright borderbottom main-for">
                            <input name="" type="submit" value="增加" class="text-but">
                        </td>
                    </tr>
                </table>
            </form>
