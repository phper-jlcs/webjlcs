     ...
     <img src="/webjlcs/Public/images/banner.jpg"  style="width: 100%;"/>
	     ...
	     <div>
            <div style="margin-bottom: 10px;margin-left: 200px">
            	...
            	<div style="float: left;font-size: 24px;margin: 5px 5px;">九龙禅寺宣传视频</b></div>
        ...
        <div>
            <div style="margin: 10px -30px;margin-left:260px;">
            	<div style="float: left;"><img src="/webjlcs/Public/images/zb.png"/></div>
            	<div style="float: left;font-size: 24px;margin: 5px 5px;">九龙迎佛</b></div>
            	<div style="float: left;"><img src="/webjlcs/Public/images/yb.png"/></div>
            </div>
            <div class="clear"></div>
            <div style="float: left;margin-right: 36px;margin-left: 180px;">
             	<div class="avatar1">
             	    <a href="/webjlcs/Home/Index/jlcs_wft">
             	    	<img class="img1" src="/webjlcs/Public/images/wanfo.jpg" style="width: 410px;margin-top: 20px;"/>
             	    </a>
             	</div>
             	<p>万佛堂</p>
            </div>
            <div style="float: left;">
             	<div class="avatar2">
             	    <a href="/webjlcs/Home/Index/jlcs_hjzc">
             		    <img class="img2" src="/webjlcs/Public/images/huangjia.jpg" style="width: 410px;margin-top: 20px;"/>            	
             	    </a>            	
             	</div>
             	<p>皇家宗祠</p>
            </div>
