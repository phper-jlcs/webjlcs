...
<div class="zhs_wft1">
    ...
    <div class="zhs_fujijie tishi" style="position:absolute; top:435px; left:290px;"><a href="<?php echo U('Product/index',array('cat_id'=>11,'img'=>aa));?>"><img src='/webjlcs/Public/images/wft/zhs/fujijie.png' class="img_fujijie"></a></div>
    <div class="zhs_fushunjie tishi" style="position:absolute; top:435px;left:658px;"><a href="<?php echo U('Product/index',array('cat_id'=>12,'img'=>bb));?>"><img src='/webjlcs/Public/images/wft/zhs/fushunjie.png' class="img_fushunjie"></a></div>
</div>
<div class="suspend">
    <dl>
        <dt class="IE6PNG"></dt>
