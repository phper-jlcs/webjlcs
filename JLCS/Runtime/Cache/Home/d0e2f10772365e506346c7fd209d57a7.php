...
<html>
	...
	<body style="overflow-x: hidden;">
				...
				<div id="headTopBg">
					<div id="headTop" class="w1024">
						<div class="headTopRight">
							<ul id="nav_all">
								<?php if($_SESSION['name']): ?><li>
										<a href=""><?php echo ($_SESSION['name']); ?></a>
									</li>
									<a href="/webjlcs/Home/Cart/index">我的认捐库</a>
									<li>
										<a href="/webjlcs/Home/User/dologot">退出</a>
									</li>
									<?php else: ?>
									<li>
										<a href="/webjlcs/Home/User/login">登录</a>
									</li>
									<li>
										<a href="/webjlcs/Home/User/register">注册</a>
									</li><?php endif; ?>
							</ul>
						</div>
					</div>
		...
		<div class="shopdetails">
			...
			<div id="leftbox">
				<div id="showbox">
					<?php if(is_array($pro)): foreach($pro as $key=>$list): ?><img src="/webjlcs/Public<?php echo ($list["path"]); ?>" width="400" height="400" />						
						<img src="/webjlcs/Public<?php echo ($list["path"]); ?>" width="400" height="400" /><?php endforeach; endif; ?>
				</div>
				<!--展示图片盒子-->
				<div id="showsum"></div>
				<!--展示图片里边-->
			...
			<!--中间-->
			<div class="centerbox">
				<?php if(is_array($pro)): foreach($pro as $key=>$list): ?><p class="imgname"><?php echo ($list["product_name"]); ?></p>

					<p class="Aprice" style="font-size: 16px;">&nbsp;&nbsp;&nbsp;原&nbsp;&nbsp;&nbsp;价：<samp>￥<?php echo ($list["product_price"]); ?></samp></p>
					<p class="price" style="font-size: 16px;">&nbsp;&nbsp;&nbsp;结缘价：<samp>￥<?php echo ($list["now_price"]); ?></samp></p>
					<div class="clear"></div>

					<p class="chima" style="font-size: 16px;">&nbsp;&nbsp;&nbsp;描&nbsp;&nbsp;&nbsp;述：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a style="font-size: 16px;"><?php echo ($list["product_description"]); ?></a>
					</p>
					<p class="chima" style="font-size: 16px;">&nbsp;&nbsp;&nbsp;库&nbsp;&nbsp;&nbsp;存：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a style="font-size: 16px;"><?php echo ($list["product_store"]); ?></a>
					</p>
					<span class="ids" id="<?php echo ($id); ?>"></span>
					<p class="buy">
						<a href="javascript:void(0)" onclick="order()" id='firstbuy' ">立即认捐</a><a href="javascript:void(0) " onclick="cart() ">加入认捐库</a></p>
   		<div class="clear "></div>
        <div class="fenx "><a href="# "></a></div>
        <p class="fuwu " style="font-size: 16px; ">服务承诺：</p>
        <p class="pay " style="font-size: 16px; ">支付方式：</p>
        <p class=" " style="font-size: 16px;position: relative;left:10px; ">实物图：</p>
            <img src="/webjlcs/Public<?php echo ($list["path"]); ?>" style="width: 160px;height: 200px;position: relative;left: 150px;top:10px; "><?php endforeach; endif; ?>
    </div>
    <div class="clear "></div>
	<!-----右边------->
   <div class="rightbox ">
       ...
       <a href="javascript:void(0);" class="ex0112" id='48184'>
		...
		<div class="evaluate">
			...
			<div class="tabbedPanels">
				<ul class="tabs">
					<li>
						<a href="#panel01" id="test">商品详情</a>
					</li>
				</ul>
				<div class="panelContainer">
					<?php if(($image == '1')): ?><div class="panel" id="panel01">
							<p class="sell">商品描述</p>
							<p style="font-size: 16px;">皇族宗祠是匠造的专属家族祠堂</p>
							<p></p>
							<p class="sell">整体款式</p>
							<div class="div1"></div>
							<div class="div1" style="width:640px;height: 642px;"><img src="/webjlcs/Public/images/details/images/01.jpg"></div>
							<img src="/webjlcs/Public/images/details/images/02.jpg">
							<img src="/webjlcs/Public/images/details/images/06.jpg" style="position: relative;left: -2px;">
							<img src="/webjlcs/Public/images/details/images/03.jpg">
							<img src="/webjlcs/Public/images/details/images/04.jpg">
							<img src="/webjlcs/Public/images/details/images/05.jpg">
							<div class="clear"></div>
						</div>
						<?php elseif(($image == '2')): ?>
							<div class="panel" id="panel01">
								<p class="sell">商品描述</p>
								<p style="font-size: 16px;">佛系产品因缘而得</p>
								<p></p>
								<p class="sell">详情介绍</p>
								<div class="div1" style="height: 700px;"><img src="/webjlcs/Public/wapimages/details/details01.png"></div>
								<div class="div1" style="height: 700px;"><img src="/webjlcs/Public/wapimages/details/details02.png"></div>
								<div class="div1" style="height: 700px;"><img src="/webjlcs/Public/wapimages/details/details03.png"></div>
								<div class="div1" style="height: 700px;"><img src="/webjlcs/Public/wapimages/details/details04.png"></div>
							</div>
						<?php else: ?>
						<div class="panel" id="panel01">
							<p class="sell">商品描述</p>
							...
							<p class="sell">整体款式</p>
							<div class="div1"></div>
							<div class="div1" style="width:640px;height: 642px;"><img src="/webjlcs/Public/images/details/image/01.jpg"></div>
							<img src="/webjlcs/Public/images/details/image/02.jpg">
							<img src="/webjlcs/Public/images/details/image/03.jpg">
							<img src="/webjlcs/Public/images/details/image/04.jpg">
							<img src="/webjlcs/Public/images/details/image/05.jpg">
							<img src="/webjlcs/Public/images/details/image/06.jpg">
							<img src="/webjlcs/Public/images/details/image/07.jpg">
		...
		function cart() {
			...
			$.post(root, {
				...
				if(data == 1) {
					...
					var nowurl = '/webjlcs/Home/Product/product?id=48184';
