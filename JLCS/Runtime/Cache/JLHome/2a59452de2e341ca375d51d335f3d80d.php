...
<html>
	<head>
		<meta charset="utf-8" />
		<title>九龙禅寺</title>
		<link rel="stylesheet" href="/webjlcs/Public/jlcss/index.css" />
		<script>
			var _hmt = _hmt || [];
			(function() {
	...
	<body>
		...
		<div class="u0">
			...
			<div class="u2">
				...
				<div  class="avatar">
					<a href="<?php echo U('inform');?>">
						<img src="/webjlcs/Public/jlimages/shouye02.jpg" class="img"/>
					</a></div>
			...
			<div class="u3">
				<h2>九龙文化<small><a href="<?php echo U('culture');?>">更多</a></small></h2>
				<a href="<?php echo U('culture');?>">
			...
			<div class="u4">
				<h2>认捐祈福</h2>
				<div  class="avatar1">
					<a href="<?php echo U('Home/Index/jlcs');?>"><img src="/webjlcs/Public/jlimages/shouye03.jpg" class="img1"/></a></div>
				<p><b><a href="<?php echo U('Home/Index/jlcs');?>">常州九龙禅寺</a></b></p>
			</div>
		    </div>
		   </div>
		<!--主题结束-->
