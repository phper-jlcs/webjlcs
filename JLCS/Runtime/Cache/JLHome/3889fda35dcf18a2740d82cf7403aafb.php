	...
	<body>
		...
		<div class="v0">
			...
			<ul>
				...
				<li><a href="<?php echo U('culture');?>" class="current" style="color: #fff;">九龙文化</a></li>
			...
			<div class="v1">
			 <table>
				...
				<?php if(is_array($culture)): foreach($culture as $key=>$list): ?><p><a href="<?php echo U('contents',array('id'=>$list['id']));?>"><?php echo ($list["name"]); ?></a></a></p><?php endforeach; endif; ?>
		    </div>
		    <div class="v2">
			 <table>
			 	<tr>
				...
				<?php if(is_array($inform)): foreach($inform as $key=>$list): ?><p><a href="<?php echo U('contents',array('id'=>$list['id']));?>"><?php echo ($list["name"]); ?></a></a></p><?php endforeach; endif; ?>
			</div>
			</div>
			<div class="v3">
				<div class="v8">
				 	...
				 	<b>九龙文化</b><small>当前位置:<a href="<?php echo U('index');?>">首页</a>><a>九龙文化</a></small>
				...
				<tr>
					<td>
						<b><a href="<?php echo U('contents',array('id'=>$zhiding['id']));?>">卍  <?php echo ($zhiding["name"]); ?></a></b>
						<small>[<?php echo ($zhiding["time"]); ?>]</small>
						<hr />
					</td>
				</tr>
				<?php if(is_array($culture)): foreach($culture as $key=>$list): ?><tr>
						<td>
							<b><a href="<?php echo U('contents',array('id'=>$list['id']));?>">卍  <?php echo ($list["name"]); ?></a></b>
							<small>[<?php echo ($list["time"]); ?>]</small>
							<hr />
						</td>
