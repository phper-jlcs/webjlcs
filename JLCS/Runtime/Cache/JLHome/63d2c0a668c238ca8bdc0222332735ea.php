...
<html>
	<head>
		<meta charset="UTF-8">
		<title>九龙宝鉴</title>
		<link rel="stylesheet" href="/webjlcs/Public/jlcss/inform.css" />
		<link href="/webjlcs/Public/jlcss/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<link rel="stylesheet" href="/webjlcs/Public/jlcss/style.css" type="text/css" media="all" />
<link rel="stylesheet" href="/webjlcs/Public/jlcss/lightbox.css">
		<script src="/webjlcs/Public/jljs/bootstrap.js"></script>
<link href="/webjlcs/Public/jlcss/animate.css" rel="stylesheet" type="text/css" media="all">
<script src="/webjlcs/Public/jljs/wow.min.js"></script>
	<script>
		 new WOW().init();
	</script>
	</head>
	<body>
		...
		<div class="v0">
			...
			<div class="u1 clear">
				<div class="u6">
					<a href="<?php echo U('index');?>"><img src="/webjlcs/Public/jlimages/logo.png" /></a>
				</div>
			<ul>
				<li><a href="<?php echo U('Home/Index/index');?>">中国帝宫</a></li>
				<li><a href="<?php echo U('index');?>">九龙禅寺</a></li>
				...
				<li><a href="<?php echo U('baokam');?>" class="current" style="color: #fff;">九龙宝鉴</a></li>
			...
			<div class="v3">
				<div class="v8">
				 	<p>
				 	<img src="/webjlcs/Public/jlimages/wawa.png" />
				 	<b>九龙宝鉴</b><span>当前位置:<a href="<?php echo U('index');?>">首页</a>><a>九龙宝鉴</a></span>
				 	<img src="/webjlcs/Public/jlimages/moxian.png" />
				 	</p>
				 </div>
				...
				<?php if(is_array($jl_images)): foreach($jl_images as $key=>$list): ?><div class="col-md-6 gallery-grid wow fadeInUp animated" data-wow-delay=".5s">
						<div class="grid">
							<figure class="effect-apollo">
								<a class="example-image-link" href="/webjlcs/Public/jlimages/4.jpg" data-lightbox="example-set" data-title="">
									<img src="/webjlcs/Public/<?php echo ($list["image"]); ?>" alt="" />
									<figcaption>
										<h3>Triplex</h3>
			    ...
			    <div class="clearfix"> </div>
					<script src="/webjlcs/Public/jljs/lightbox-plus-jquery.min.js"> </script>
				</div>
			</div>					
		</div>
		</div>
