	...
	<body>
		...
		<div class="v0">
			...
			<ul>
				...
				<li><a href="<?php echo U('down');?>" class="current" style="color: #fff;">下载专区</a></li>
			...
			<div class="v3">
				<div class="v8">
				 	...
				 	<b>下载专区</b><small>当前位置:<a href="<?php echo U('index');?>">首页</a>><a>下载专区</a></small>
				 	<img src="/Public/jlimages/moxian.png" />
				 	</p>
				 </div>
				 <div class="v10">
					 <?php if(is_array($jl_images)): foreach($jl_images as $key=>$list): ?><div>
							 <a href="<?php echo U('download',array('id'=>$list['id']));?>"> <img src="/Public/<?php echo ($list["image"]); ?>"/>
								 <p>1920X1080<small>下载</small></p></a>
