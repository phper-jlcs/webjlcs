...
<html>
	<head>
		<meta charset="UTF-8">
		<title>寺院通告</title>
		<link rel="stylesheet" href="/webjlcs/Public/zhcss/inform.css" />
	</head>
	<body>
		<div class="v">
		<div class="v0">
			...
			<ul>
				...
				<li><a href="<?php echo U('inform');?>" class="current" style="color: #fff;">寺院通告</a></li>			
			...
			<div class="v1">
			 <table>
				...
				<?php if(is_array($culture)): foreach($culture as $key=>$list): ?><p><a href="<?php echo U('contents',array('id'=>$list['id']));?>">卍  感受孟河：<?php echo ($list["name"]); ?></a></p><?php endforeach; endif; ?>
		    </div>
		    <div class="v2">
			 <table>
			 	<tr>
				...
				<?php if(is_array($inform)): foreach($inform as $key=>$list): ?><p><a href="<?php echo U('contents',array('id'=>$list['id']));?>">卍  感受孟河：<?php echo ($list["name"]); ?></a></p><?php endforeach; endif; ?>
			</div>
			</div>
			<div class="v3">
				<div class="v8">
				 	...
				 	<b>寺院通告</b><span>当前位置:<a href="<?php echo U('index');?>">首页</a>><a>寺院通告</a></span>
		...
		<div class="footer">
			...
			<span><img src="/webjlcs/Public/jlimages/address.png"/><b>江苏省常州市新北区镇海路98号 </b> <img src="/webjlcs/Public/jlimages/phone.png"/><strong>0519-8324 7330</strong></span>
