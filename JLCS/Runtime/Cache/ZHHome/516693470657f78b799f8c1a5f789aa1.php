	...
	<body>
		...
		<div class="v0">
			...
			<ul>
				...
				<li><a href="<?php echo U('study');?>" class="current" style="color: #fff;">学习园地</a></li>
				</ul>
			</div>
			<!--头部结束-->
			</div>
			...
			<div class="v3">
				<div class="v8">
				 	...
				 	<b>学习园地</b><small>当前位置:<a href="<?php echo U('index');?>">首页</a>><a>学习园地</a></small>
				...
				<tr>
					<td>
						<b><a href="">卍  <?php echo ($zhiding["name"]); ?></a></b>
					...
					<?php if(is_array($study)): foreach($study as $key=>$list): ?><tr>
							<td>
								<b><a href="<?php echo U('contents',array('id'=>$list['id']));?>">卍  感受孟河：<?php echo ($list["name"]); ?></a></b>
